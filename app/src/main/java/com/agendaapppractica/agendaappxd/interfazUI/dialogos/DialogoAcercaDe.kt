...
fun DialogoAcercaDe(onDismiss: () -> Unit) {
    AlertDialog(
        ...
        shape = RoundedCornerShape(28.dp), // Esquinas redondeadas consistentes con tus otros diálogos
        title = {
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                // Esto cambiará automáticamente a v1.1.5 apenas se instale la APK actualizada
